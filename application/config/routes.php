...
$cat_uri = array(
	/* Main Category: metropolitan */
	'surabaya-raya',
	'surabaya', 'mojokerto', 'gresik', 'jombang', 'sidoarjo',
	/* Main Category: News */
	'hot-news',
	'nasional', 'internasional', 'regional', 'unik',
	/* Main Category: Persebaya */
	'persebaya',
	/* Main Category: Olahraga */
	'sport', 'arema', 'madura-united', 'sepak-bola',
	/* Main Category: Tren */
	'tren', 'otomotif', 'gadget', 'fashion',
	/* Main Category: Wisata */
	'wisata',
	'kuliner', 'destinasi', 'gaya-hidup', 'modern',
	/* Main Category: Bisnis */
	'bisnis',
	/* Main Category: Pendidikan */
	'inovasi',
	/* Main Category: Sehat */
	'netizen',
...
$route['pencarian'] 			= "page/pencarian";
...
$route['pedoman-media-siber']		= "page/privacy_policy";
