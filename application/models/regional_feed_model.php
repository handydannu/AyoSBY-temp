...
class Regional_feed_model extends CI_Model
{
	...
	function get($reg_name)
	{
		...
		} else if($reg_name == 'batang') {
			$src_url = 'http://ayobatang-desktop';
			$base_url = 'http://ayobatang.com';
		} else if($reg_name == 'purwakarta') {
			$src_url = 'http://ayopurwakarta-desktop';
			$base_url = 'http://ayopurwakarta.com';
		} else if($reg_name == 'tegal') {
			$src_url = 'http://ayotegal-desktop';
			$base_url = 'http://ayotegal.com';
		} else if($reg_name == 'semarang') {
			$src_url = 'http://ayosemarang-desktop';
			$base_url = 'http://ayosemarang.com';
		} else if($reg_name == 'surabaya') {
			$src_url = 'http://ayosurabaya-desktop';
			$base_url = 'http://ayosurabaya.com';
		} else if($reg_name == 'yogya') {
			$src_url = 'http://ayoyogya-desktop';
			$base_url = 'http://ayoyogya.com';
		} else if($reg_name == 'banten') {
			$src_url = 'http://ayobanten-desktop';
			$base_url = 'http://ayobanten.com';
		} else if($reg_name == 'jakarta') {
			$src_url = 'http://ayojakarta-desktop';
			$base_url = 'http://ayojakarta.com';
		} else {
			return false;
		}
