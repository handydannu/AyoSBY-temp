      ...
      <div class="col-lg-8 col-sm-12 mt-3"><!-- main col read -->
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-arrow p-0">
            ...
            <li aria-current="page" class="breadcrumb-item pl-0 active text-uppercase pl-4">Privacy and Policy</li>
          </ol>
        </nav><!-- breadcrumb -->
        ...
        <section>          
          ...
          <h2 class="page-subheader mt-3">Privacy Policy</h2>          
          <h2 class="page-subheader mt-3">Peraturan Dewan Pers <br>
          Pedoman Pemberitaan Media Siber</h2>
