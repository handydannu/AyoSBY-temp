<!-- netizen -->
<h4 class="pt-2">
  <a class="roll-link" href="<?php echo base_url();?>netizen">
    <span data-title="LAINNYA >>"><i class="fas fa-comments"></i> AYONETIZEN</span></a>
</h4>
<div class="rounded-0 mr-2">
  ...
  <ul class="list-group list-group-flush left-orange-title mt-3">
    <?php for($i = 1; $i < count($netizen); $i++) { ?>
      ...
      ?>
    <li class="pop-list">
      <a class="sub-head-14" href="<?php echo $url; ?>">
        <?php echo $netizen[$i]['post_title']; ?>          
      </a>
    </li>         
      <?php } ?>
  </ul>
