        ...
        <header style="padding-top: 60px;">
          ...
          <div id="fix-banner-top">
            <a href="#" target="_blank" title="AyoSurabaya">
              ...
              <!-- <img src="http://www.ayobekasi.net/assets/ads/2020/05/hut59bjb.jpg?w=1197" class="img-responsive" /> -->
              <!-- <img src="https://cdn.ayobandung.com/upload/bank_image/medium/Selamat_Hari_Raya_Idul_Adha1.png" class="img-responsive" /> -->
              <img src="https://cdn.ayobandung.com/upload/bank_image/medium/BJB_Amazing_Sureprize.png?w=1197" class="img-responsive" />
              <!-- <img src="https://cdn.ayobandung.com/upload/bank_image/medium/BJB_HUT_BANTEN.png?w=1197" class="img-responsive" /> -->
            </a>
          </div>
          <!-- E: Fix Banner Top -->
          <?php } ?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-3 col-md-pull-6 col-xs-6">
                  ...
                  <span class="todays-date-bg todays-date-bg-side" style="background: #e1e1e1;color: #000;">
                    &nbsp;&nbsp;
