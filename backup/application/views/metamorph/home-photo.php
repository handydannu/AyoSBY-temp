                      ...
                      <div class="col-photo-title">
                        <h3>
                          <a href="<?php echo site_url();?>foto" title="Menuju ke Halaman &quot;Ayo Foto&quot;">
                            <b style="color: #FFFFFF;"><i class="fa fa-camera"></i>&nbsp;&nbsp;Ayo Fotod</b>
                          </a>
                        </h3>
                      </div>
                          ...
                          <div class="col-md-4">
                            <figure>
                              <a href="<?php echo $url[0]; ?>">
                                  <img src="<?php echo $url_img[0] . $photo[0]['post_image_thumb']; ?>" class="img-responsive" />
                              </a>
                              <figcaption>
                                <a href="<?php echo $url[0]; ?>">
                          ...
                          <div class="col-md-4">
                            <figure>
                              <a href="<?php echo $url[1]; ?>">
                                  <img src="<?php echo $url_img[1] . $photo[1]['post_image_thumb']; ?>" class="img-responsive" />
                              </a>
                              <figcaption>
                               <div class="photoline"></div><i class="fa fa-camera" style="color: rgba(0, 0, 0, 0.4);position: absolute;top: -90px;right: 150px;"></i>
                          ...
                          <div class="col-md-4">
                            <figure>
                              <a href="<?php echo $url[2]; ?>"><i class="fa fa-camera" style="color: rgba(0, 0, 0, 0.4);position: absolute;top: -90px;right: 150px;"></i>
                                  <img src="<?php echo $url_img[2] . $photo[2]['post_image_thumb']; ?>" class="img-responsive" />
                              </a>
                              <figcaption>
                          ...
                          <div class="col-md-4">
                            <figure>
                              <a href="<?php echo $url[3]; ?>">
                                  <img src="<?php echo $url_img[3] . $photo[3]['post_image_thumb']; ?>" class="img-responsive" />
                              </a>
                              <figcaption>
                                <div class="photoline"></div><i class="fa fa-camera" style="color: rgba(0, 0, 0, 0.4);position: absolute;top: -90px;right: 150px;"></i>
                          ...
                          <div class="col-md-4">
                            <figure>
                              <a href="<?php echo $url[4]; ?>">
                                  <img src="<?php echo $url_img[4] . $photo[4]['post_image_thumb']; ?>" class="img-responsive" />
                              </a>
                              <figcaption>
                                <div class="photoline"></div><i class="fa fa-camera" style="color: rgba(0, 0, 0, 0.4);position: absolute;top: -90px;right: 150px;"></i>
                          ...
                          <div class="col-md-4">
                            <figure>
                              <a href="<?php echo $url[5]; ?>">
                                  <img src="<?php echo $url_img[5] . $photo[5]['post_image_thumb']; ?>" class="img-responsive" />
                              </a>
                              <figcaption>
                                <div class="photoline"></div><i class="fa fa-camera" style="color: rgba(0, 0, 0, 0.4);position: absolute;top: -90px;right: 150px;"></i>
