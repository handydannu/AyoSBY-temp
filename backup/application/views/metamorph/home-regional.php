                        ...
                        <li>
                          <span class="regional-list">
                            <span class="regional-meta">
                              ...
                              <!-- <span class="regional-list-desc"><?php echo $feed['bekasi']['post_summary']; ?></span> -->
                        ...
                        <li class="even">
                          <span class="regional-list">
                            <span class="regional-meta">
                              ...
                              <!-- <span class="regional-list-desc"><?php echo $feed['bogor']['post_summary']; ?></span> -->
                              <span class="regional-date">
                        ...
                        <li>
                          <span class="regional-list">
                            <span class="regional-meta">
                              ...
                              <!-- <span class="regional-list-desc"><?php echo $feed['cirebon']['post_summary']; ?></span> -->
                              <span class="regional-date">
                        ...
                        <li class="even">
                          <span class="regional-list">
                            <span class="regional-meta">
                              ...
                              <!-- <span class="regional-list-desc"><?php echo $feed['tasik']['post_summary']; ?></span> -->
                              <span class="regional-date">
                        ...
                        <li>
                          <span class="regional-list">
                            <span class="regional-meta">
                              ...
                              <!-- <span class="regional-list-desc"><?php echo $feed['purwakarta']['post_summary']; ?></span> -->
                              <span class="regional-date">
