            ...
            <div class="row">
              ...
              <article class="col-md-8">
                ...
                <div class="col-news-content col-page-content col-page-advertise">
                  ...
                  <p>Kantor <strong><span class="ayo-orange">Ayo</span>Bogor.com</strong></p>
                  ...
                  <p class="contact-info"><strong>Email</strong>: <!-- <i class="fa fa-envelope"></i>&nbsp;&nbsp; -->sosmed@ayobandung.com</p>
                  <p class="contact-info"><strong>WhatsApp</strong>: <!-- <i class="fa fa-whatsapp"></i>&nbsp;&nbsp; -->0811 2069 272</p>
