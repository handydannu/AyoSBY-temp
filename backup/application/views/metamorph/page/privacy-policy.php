              ...
              <article class="col-md-8">
                ...
                <div class="col-news-content col-page-content">
                  <h2 class="page-subheader">
                    <span class="split">Peraturan Dewan Pers</span>
                    <span class="split">Pedoman Pemberitaan Media Siber</span>
                  </h2>
                  ...
                  <ol class="list-page-subheader">
                    <li>
                      ...
                      <ol>
                        ...
                        <li>Isi Buatan Pengguna (<em>User Generated Content</em>) adalah segala isi yang dibuat dan atau dipublikasikan oleh pengguna media siber, antara lain, artikel, gambar, komentar, suara, video dan berbagai bentuk unggahan yang melekat pada media siber, seperti blog, forum, komentar pembaca atau pemirsa, dan bentuk lain.</li>
                      </ol>
                    </li>
                    <li>
                      <strong>Verifikasi dan keberimbangan berita</strong>
                      <ol>
                    ...
                    <li>
                      <strong>Isi Buatan Pengguna (<em>User Generated Content</em>)</strong>
                      <ol>
                    ...
                    <li>
                      <strong>Ralat, Koreksi, dan Hak Jawab</strong>
                      <ol>
                    ...
                    <li>
                      <strong>Pencabutan Berita</strong>
                      <ol>
                    ...
                    <li>
                      ...
                      <p class="pg-list">Media siber wajib menghormati hak cipta sebagaimana diatur dalam peraturan perundang-undangan yang berlaku.</p>
                    </li>
                    <li>
                      <strong>Pencantuman Pedoman</strong>
                      <p class="pg-list">Media siber wajib mencantumkan Pedoman Pemberitaan Media Siber ini di medianya secara terang dan jelas.</p>
                    </li>
                    <li>
                      <strong>Sengketa</strong>
                      <p class="pg-list">Penilaian akhir atas sengketa mengenai pelaksanaan Pedoman Pemberitaan Media Siber ini diselesaikan oleh Dewan Pers.</p>
                    </li>
                  </ol>
                </div>
