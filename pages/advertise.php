<div class="col-lg-8 col-sm-12 mt-3"><!-- main col read -->
    ...
    <h2 class="page-subheader mt-3">Advertise</h2>

    <p><strong>Untuk Pemasangan Iklan Hubungi:</strong></p>
    <p><strong>Kontak</strong>: Kusnadi/ Ellisa Nursanti</p>
    <p><strong>Alamat</strong>: Jl. Erlangga Tengah 3 No. 17 Semarang 50241</p>
    <p><strong>Email</strong>: semarang@ayomedia.com</p>
    <p><strong>Telepon</strong>: (024) 76585185</p> 
